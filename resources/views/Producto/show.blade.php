                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="panel-content">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="text-right"> {{ $producto->nombre }}<span></td>
                                                    </div>
                                                    <div class="form-group">
                                                        <td><label><b>Coste de producción: </b><label></td>
                                                        <td><span>  {{ $producto->precio_in }}<span></td>
                                                    </div>
                                                    <div class="form-group">
                                                        <td><label><b>Coste de venta: </b><label></td>
                                                        <td><span> {{ $producto->precio_out }}<span></td>
                                                    </div>
                                                    <div class="form-group">
                                                        <td><label><b>Receta: </b><label></td>
                                                        <td><span> {{ $producto->receta }}<span></td>
                                                    </div>
                                                    <div class="form-group">
                                                        <td><label><b>Descripción: </b><label></td>
                                                        <td><span> {{ $producto->descripción }}<span></td>
                                                    </div>
                                                    <a href="{{ route('productos.edit', $producto->id) }}" class="btn btn-warning"><i class="fa fa-check-circle"></i> Editar</a>
                                            </div>
                                            <form action="{{ route('productos.destroy', $producto->id) }}" method="POST" onsubmit="return confirm('Are you sure abour that?');">
                                                {{ csrf_field() }}
