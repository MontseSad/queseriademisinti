        ...
        <div id="main-content">
            <div class="container-fluid">
                ...
                <div class="section-heading clearfix">
                        <h2 class="section-title"><i class="fa fa-plus-circle"></i> Crear nuevo producto para preparar</h2>
                            ...
                            <div class="panel-content">
                                ...
                                <div class="table-responsive">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <!-- ACCORDION -->
                                            {!! Form::model($quesero, array('route' => array('queseros.update', $quesero->id), 'method' => 'PUT')) !!}
                                                @include('layouts.form_quesero')
                                            {!! Form::close() !!}
                                        </div>
                                    </div>
                                </div>
